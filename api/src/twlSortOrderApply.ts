...
// post-pass (bookReimport). Sets sort_order (+ updated_at) only — it does NOT
// bump version, does NOT touch content/updated_by, and does NOT write edit_log
// (a reorder is transient last-write-wins, not a versioned content edit).
