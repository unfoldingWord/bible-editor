...
2026-07-17 · **feat/admin-user-management** — **In-app admin UI for the `user_roles` allowlist — no more raw SQL to grant/revoke editor or admin access.**
...
- **PR:** opened against `deferredreward/bible-editor-multilingual` (fork), not upstream. Flagged in the PR body: this touches all 14 i18n locale files, the most likely collision point with parallel worktrees also mid-flight on i18n.
