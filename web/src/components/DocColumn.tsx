        ...
        <Tooltip title={`save verse ${verseNum}`}>
          <IconButton
            onClick={(e) => {
              ...
              // from marker-free `text` in several places (mount, resync,
              // undo) and only the active-editable `onInput` handler ever
              // corrects it to the chip-bearing text. A draft created
